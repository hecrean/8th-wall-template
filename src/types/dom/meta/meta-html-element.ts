 ...
 * @since 8.1.0
 */
import { MetaElement, MatchElementTagName } from "./meta-element";

// CONVENIENCE TYPES:
export type HTMLElementsTagNames = AllHTMLElementMeta["_tagName"];
export type HTMLElementsElements = AllHTMLElementMeta["_element"];

export type HTMLElementsEventMaps = AllHTMLElementMeta["_eventMap"];
 ...
 * @since 8.1.0
 */
export type MatchHTMLElementTagName<R extends string> =
 ...
 * @since 8.1.0
 */
export type MatchHTMLElementElement<E extends HTMLElement> =
  AllHTMLElementMeta extends infer T
 ...
 * @since 8.1.0
 */
export type MatchHTMLElementEventMap<A extends HTMLElementEventMap> =
  AllHTMLElementMeta extends infer T
 ...
 * @since 8.1.0
 */
export type HTMLButtonElementMeta = MetaHTMLElement<
  "button",
  HTMLButtonElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLCanvasElementMeta = MetaHTMLElement<
  "canvas",
  HTMLCanvasElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLDialogElementMeta = MetaHTMLElement<
  "dialog",
  HTMLDialogElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLIFrameElementMeta = MetaHTMLElement<
  "iframe",
  HTMLIFrameElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLLegendElementMeta = MetaHTMLElement<
  "legend",
  HTMLLegendElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLObjectElementMeta = MetaHTMLElement<
  "object",
  HTMLObjectElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLOptionElementMeta = MetaHTMLElement<
  "option",
  HTMLOptionElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLOutputElementMeta = MetaHTMLElement<
  "output",
  HTMLOutputElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLScriptElementMeta = MetaHTMLElement<
  "script",
  HTMLScriptElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLSelectElementMeta = MetaHTMLElement<
  "select",
  HTMLSelectElement
>;
 ...
 * @since 8.1.0
 */
export type HTMLSourceElementMeta = MetaHTMLElement<
  "source",
  HTMLSourceElement
>;
