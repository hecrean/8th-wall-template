 ...
 * @since 8.1.0
 */
export type MatchElementTagName<R extends string> =
 ...
 * @since 8.1.0
 */
export type MatchElementElement<E extends Element> =
  AllElementMeta extends infer T
 ...
 * @since 8.1.0
 */
export type MatchElementEventMap<A extends ElementEventMap> =
  AllElementMeta extends infer T
