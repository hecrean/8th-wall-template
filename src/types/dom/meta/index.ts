...
export type MatchElementsByTagName<T extends ElementsTagNames> =
...
export type MatchHTMLElementsByTagName<T extends HTMLElementsTagNames> =
...
export type MatchSVGElementsByTagName<T extends SVGElementsTagNames> =
...
export type MatchElementByElement<E extends ElementsElements> =
  Elements extends infer U
...
export type MatchHTMLElementByElement<E extends HTMLElementsElements> =
  HTMLElements extends infer U
...
export type MatchSVGElementByElement<E extends SVGElementsElements> =
  SVGElements extends infer U
...
export type MatchElementByEventName<EN extends ElementsEventNames> =
  Elements extends infer U
...
export type MatchSVGElementByEventName<EN extends SVGElementsEventNames> =
  SVGElements extends infer U
...
export type MatchElementByEvent<EV extends ElementsEvents> =
  Elements extends infer U
...
export type MatchHTMLElementByEvent<EV extends HTMLElementsEvents> =
  HTMLElements extends infer U
    ? U extends MetaHTMLElement<
        any,
        any,
        ElementEventMap & Record<any, infer V>
      >
      ? V extends EV
        ? U
        : never
...
export type MatchSVGElementByEvent<EV extends SVGElementsEvents> =
  SVGElements extends infer U
