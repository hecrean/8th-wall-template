...
export const responseToInput = (input: Input, [renderCxt, sceneGraphCxt, userCtx]: State) => {
    const { threeEvent } = raycasterApi;
    const intersectionEvts = threeEvent(input.canvasEvent)(sceneGraphCxt)(renderCxt);
