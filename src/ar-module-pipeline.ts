...
import { initSceneGraphCtx, SceneGraphCtx, RenderCxt, UserCtx, initUserCtx } from './state';
...
const ArPipelineModule = ([sceneGraphCtx, userCtx]: [SceneGraphCtx, UserCtx]): CameraPipelineModule => {
    // define variables
    ...
    return {
        ...
        onStart: (
            ...
            input$.subscribe((input) => responseToInput(input, [renderCtx, sceneGraphCtx, userCtx]));
